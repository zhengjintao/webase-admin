...
const api = {
  user: '/dashboard',
  shiplist: '/dashboard/list',
  lockUser: '/dashboard/{id}/lock',
  role: '/role',
  service: '/service',
...
export function getUserListByUserName (parameter) {
  return axios({
    url: api.shiplist,
    method: 'get',
    params: parameter
...
export function createShipInfo (parameter) {
  return axios({
    url: api.user,
    method: 'post',
    data: parameter
...
export function updateShipInfo (parameter) {
  return axios({
    url: api.user,
    method: 'put',
    data: parameter
